...
function Home(){
    return (
        <div>
            ...
            <div>
                <h1 style={{marginTop:"-2rem", fontWeight:"400"}}>BESTSELLERS</h1>
            ...
            <div>
                <h1 style={{fontWeight:"400"}}>HOT DEALS</h1>
            ...
            <div>
                <h1 style={{fontWeight:"400"}}>JUST-IN</h1>
                <div style={{display:"flex",marginTop:"20px",marginBottom:"30px",justifyContent:"center",gap:"30px"}}>
                <div style={{height:"320px",width:"250px",boxShadow: 'rgba(0, 0, 0, 0.16) 0px 1px 4px'}}>
            ...
            <div>
                <h1 style={{fontWeight:"400"}}>TOP PICKS OF THE WEEK</h1>
                <div style={{display:"flex",marginTop:"10px",justifyContent:"center",gap:"20px",marginBottom:"20px"}}>
                      <div style={{height:"300px",width:"400px"}}>
            ...
            <div>
                <h1 style={{fontWeight:"400"}}>GIFTING</h1>
            ...
            <div>
                <h1 style={{fontWeight:"400",marginBottom:"25px"}}>REFER YOUR FRIENDS</h1>
            ...
            <div>
                <h1 style={{fontWeight:"400"}}>SUPER SAVERS</h1>
            ...
            <div style={{marginTop:"-30px",marginBottom:"20px"}}>
                ...
                <div style={{display:"flex",justifyContent:"center",gap:"70px"}}>
                    <img  style={{height:"350px",width:"550px"}} src="https://d32baadbbpueqt.cloudfront.net/Homepage/d1b038a4-418a-4309-92b1-9aff3b4393ea.jpg" alt=""/>
                    <img  style={{height:"350px",width:"550px"}}src="https://d32baadbbpueqt.cloudfront.net/Homepage/aacbf133-247d-4ad9-a6ea-4510ab9adf09.jpg" alt=""/>
                </div>
            </div>
            <div>
                <h1 style={{fontWeight:"400"}}>SKINCARE BASICS</h1>
                <div style={{display:"flex",marginTop:"20px",marginBottom:"40px",justifyContent:"center",gap:"30px"}}>
                <div style={{height:"320px",width:"250px",boxShadow: 'rgba(0, 0, 0, 0.16) 0px 1px 4px'}}>
            ...
            <div style={{marginBottom:"20px"}}>
                 <h1 style={{fontWeight:"400",marginBottom:"20px"}}>QUICK TIPS</h1>
                 <Slider3/>
            </div>
            <div style={{marginBottom:"20px",marginTop:"-60px"}}>
                <h1 style={{fontWeight:"400",marginBottom:"20px"}}>EXPLORE</h1>
                <div style={{display:"flex",justifyContent:"center",gap:"20px"}}>
                    <img style={{height:"220px",width:"300px"}} src="https://d32baadbbpueqt.cloudfront.net/Homepage/6467c459-adbc-4edf-a00f-144d1dff5ea6.jpg" alt=""/>
                    <img style={{height:"220px",width:"300px"}} src="https://d32baadbbpueqt.cloudfront.net/Homepage/7c5a1a8e-bc23-4737-a429-afff37e95d4e.jpg" alt=""/>
                    <img style={{height:"220px",width:"300px"}} src="https://d32baadbbpueqt.cloudfront.net/Homepage/d3e932be-f181-4db6-b02f-866c25777902.jpg" alt=""/>
                    <img style={{height:"220px",width:"300px"}} src="https://d32baadbbpueqt.cloudfront.net/Homepage/0f06a6f1-f07e-4141-ab7c-4db648fd9b9e.jpg" alt=""/>
                </div>
            </div>
        </div>
    )
